<template>
  <router-link to="CreateAkunAdmin"
  ...
  <table class="table table:border secondary-5:border">
    <thead>
      ...
      <tr>
        <td>#</td>
        <td><input type="search" class="input" placeholder="Filter Username" v-model="col.name" @keyup="filterByColumn"></td>
        <td><input type="search" class="input" placeholder="Filter Email" v-model="col.email" @keyup="filterByColumn"></td>
        <td>#</td>
      </tr>
    </thead>
    <tbody>
      <tr v-for="(td, index) in tableData" :key="td">
        ...
        <td>
          <div class="btn-group">
            <router-link :to="{name:'pengaturan.editakunadmin', params:{id: td.id}}" class="btn btn-sm btn-outline-info">Edit</router-link>
            <router-link :to="{name:'pengaturan.deleteakunadmin', params:{id: td.id}}" class="btn btn-sm btn-outline-danger">Delete</router-link>
          </div>
        </td>
      </tr>
    </tbody>
